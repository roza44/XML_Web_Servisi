package ZalbaNaCutanje;

import ZalbaNaCutanje.model.Zalba;
...
public class Store {
    ...
    private static final String SCHEMA_URL = "./../Dokumenti/XML Seme/zalbacutanjecir.xsd";
    private static final String IN_URL = "./../Dokumenti/XML Dokumenti/Ulaz/ZalbaNaCutanje1.xml";
//    private static final String OUT_URL = "./../Dokumenti/XML Dokumenti/Izlaz/ZalbaNaCutanje1.xml";
    ...
    public static void run(AuthenticationUtilities.ExistProperties conn) throws Exception {
        ...
        System.out.println("[INOF] " + Store.class.getSimpleName());
    ...
    public static void storeRdf() throws IOException, SAXException, TransformerException {

        final String SPARQL_NAMED_GRAPH_URI = "/zalbaNaCutanje1Metadata";
        ...
        String rdfFilePath = "ZalbaNaCutanje1.rdf";
