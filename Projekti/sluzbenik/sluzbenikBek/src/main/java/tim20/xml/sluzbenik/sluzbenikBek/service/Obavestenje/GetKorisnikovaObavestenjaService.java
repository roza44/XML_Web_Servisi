...
@Service
public class GetKorisnikovaObavestenjaService implements GetKorisnikovaObavestenjaUseCase{

    private final AuthenticationService authService;
    private final ObavestenjeRepository repository;

    private final String queryPath = "src/main/resources/data/query/getKorisnikovaObavestenja.xqy";
